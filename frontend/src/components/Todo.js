...
const Todo = (props) => {
  ...
  const convertEmptyConstraints = () => {
    let tempUpdatedTasks = updated_tasks
    for (const key of Object.keys(updated_tasks)) {
      if (tempUpdatedTasks[key].constraints === '000000000000000000000') {
        tempUpdatedTasks[key].constraints = '111111111111111111111'
      }
    }
